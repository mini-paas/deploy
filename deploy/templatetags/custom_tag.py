...
# @register.filter(name='tasklogdetail_event_log')
# def tasklogdetail_event_log(task_id):
#     tasklogdetail = get_object(TaskLogDetail, id=task_id)
#     if tasklogdetail.event_log:
#         return tasklogdetail.event_log
#     else:
#         return 0

@register.filter(name='stingsss')
def stingsss(format_string):
    return str(format_string).split('-')[0]
